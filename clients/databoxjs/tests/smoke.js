 ...
 * databox node.
 *
 *     bun tests/smoke.js --endpoint localhost:18443 --password devpass123
 */

import { Databox, ConflictError } from "../src/index.js";
...
const PREFIX = "/smoketest-js";
const LOCKNS = "smoketest-js"; // lock resources are plain names, no leading slash
...
let streamedLen = 0;
for await (const chunk of stream) streamedLen += chunk.length;
...
console.log("ALL JAVASCRIPT SMOKE TESTS PASSED");
process.exit(0);
